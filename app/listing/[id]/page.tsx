          ...
          <div className="bg-white rounded-[2rem] border border-[#edeff1] shadow-[0_8px_40px_rgb(0,0,0,0.05)] p-8 overflow-hidden">
            ...
            <div className="space-y-4">
               {listing.profiles?.has_whatsapp ? (
                 ...
                 <Link 
                   href={`/auth/register?redirectTo=/listing/${listing.id}`} 
                   className="block w-full bg-[#f0f2f5] hover:bg-[#e4e6eb] text-[#1c1c1c] p-4 rounded-2xl text-center text-[0.95rem] font-black transition-all active:scale-[0.98] border border-[#edeff1]"
                 >
                   <div className="flex items-center justify-center gap-2">
                     <svg className="w-5 h-5 text-[#65676B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                     سجل لإظهار الرقم
                   </div>
                 </Link>
               )}
